...
public final class Landbound extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        configPlayer.playersFolders = new File(getDataFolder(), "players");
        Bukkit.getPluginManager().registerEvents(new configPlayer(), this);
        ...
        Bukkit.getScheduler().runTaskTimer(this, () -> {
            Bukkit.getOnlinePlayers().forEach(player -> {
                configPlayer confPlayer = new configPlayer();
                confPlayer.saveConfigs();
